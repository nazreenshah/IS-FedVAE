...
# python sampler.py --dataset="MNIST" --n_clients=4 --alpha=1.0
...
if(args.dataset=="MNIST"):
    n_classes = 10
    train_data = datasets.MNIST(f'{args.data_dir}/dataset/MNIST', train=True, download=True,
        transform=transforms.Compose([transforms.ToTensor()]))
    test_data = datasets.MNIST(f'{args.data_dir}/dataset/MNIST', train=False, download=True,
        transform=transforms.Compose([transforms.ToTensor()]))
